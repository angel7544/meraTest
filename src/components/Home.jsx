    ...
    <div className="overflow-x-hidden">
      ...
      >
        ...
        <span className="sm:block"> Increase Conversion. </span>
            ...
            <Typed    className="bg-gradient-to-r pl-3 from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl" strings={["Here you can find anything related to PC BUILDING and GAMING","BUDGET-PCs","GAMING-PCs","Graphics Cards & Monitors ","PC Components & Accessories"]} backSpeed={50} loop={true} typeSpeed={80} />
